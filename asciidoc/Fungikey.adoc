...
- Première feature: Permettre a l'utilisateur de prendre une photo d'un champignon.


- Deuxième feature: Afficher une carte avec la localisation de l'utilisateur.


- troisième feature: Afficher les 3 champignons les plus proches de l'utilisateur.
