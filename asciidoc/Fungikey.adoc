...
Elle permet d'effectier la recherche de champignon selon la forme

- Troisième feature: Les recettes : 

La présentation de recettes à partir de champignons, et son diaframme de sequence est donc comme suit :
