        ...
        <div className="card">
          ...
          <div class="card-front">
              ...
              <ul>
                ...
                {randomMushroom.type_chapeau.type_lames ? <li>Type lames: {randomMushroom.type_chapeau.type_lames}</li> : ""}
                {randomMushroom.type_chapeau.couleur_spores ? <li>Couleur spores: {randomMushroom.type_chapeau.couleur_spores}</li> : ""}
                {randomMushroom.type_chapeau.stipe ? <li>Stipe: {randomMushroom.type_chapeau.stipe}</li> : ""}
                {randomMushroom.type_chapeau.trame ? <li>Trame: {randomMushroom.type_chapeau.trame}</li> : ""}
                {randomMushroom.type_chapeau.forme ? <li>Forme: {randomMushroom.type_chapeau.forme}</li> : ""}
                {randomMushroom.type_chapeau.cuticule ? <li>Forme: {randomMushroom.type_chapeau.cuticule}</li> : ""}
              </ul>
          </div>
          ...
          <button className='button-retour' onClick={handleShow} >Réponse</button>
