...
import JSONDATA from '../../asset/champi.json'
...
<div>
  <div className="conseil-bar"><span className="conseil-title">Conseils Champignons</span></div>
  ...
  <div>
    ...
    <input className='input'
      ...
      {JSONDATA.filter((val) => {
          ...
          } else if ((val.nom.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "").includes(
        ...
        }).map(({nom,nomlatin,toxic,famille,image,conseils,comestible,description})=> (
...
<Card style={{ overflow: "auto", width: "100%", }}>
  ...
  <Card.Body>
    ...
    <Card.Text>
      ...
      <p>{toxic ? "" : "Conseils de cueillette et de préparation: " +conseils }</p>
...
<br />
  ...
  <a href="https://www.guidedeschampignons.com/tous-les-champignons/" target="_blank" >Le guide des champignons</a>
  <br/>
  <a href="https://fr.vikidia.org/wiki/Cat%C3%A9gorie:Champignon" target="_blank" >Vikidia</a>
  <br/>
  <a href="https://www.chasseursdechampignons.com/blog/comment-trouver-des-champignons/" target="_blank" >Chasseurs des champignons</a>
  <br/>
  <a href="https://www.dinosoria.com/champignon.html" target="_blank" >Dinosoria</a>
  </div>
