  ...
  return (
    ...
    <div className='container-identification'>
      ...
      <ul>
        ...
        <li>A partir des indices données, essayez de deviner la famille de champignons. Cliquez sur "réponse" pour vérifier! </li>
        <li>Cliquez sur "Recommencer" pour générer une autre question!</li>
      </ul>
      <h2>Jeu par champignons</h2>
      <ul>
        <li>Réviser vos champignons</li>
        <li>A partir des indices données, essayez de deviner le champignon. Cliquez sur "réponse" pour vérifier! </li>
        <li>Cliquez sur "Recommencer" pour générer une autre question!</li>
      </ul>
      <h2>4 Images 1 Mot</h2>
      <ul>
        <li>Parmi quatre images, choisissez l'image qui correspond au champignon</li>
