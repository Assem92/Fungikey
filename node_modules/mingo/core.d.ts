 ...
 */
export declare type CollectionResolver = (name: string) => Array<RawObject>;
 ...
 */
export declare type JsonSchemaValidator = (schema: RawObject) => Predicate<RawObject>;
/**
...
export declare type AccumulatorOperator = (collection: RawArray, expr: AnyVal, options?: Options) => AnyVal;
export declare type ExpressionOperator = (obj: AnyVal, expr: AnyVal, options?: ComputeOptions) => AnyVal;
export declare type PipelineOperator = (collection: Iterator, expr: AnyVal, options?: Options) => Iterator;
export declare type ProjectionOperator = (obj: RawObject, expr: AnyVal, selector: string, options?: Options) => AnyVal;
export declare type QueryOperator = (selector: string, value: AnyVal, options?: Options) => (obj: RawObject) => boolean;
export declare type WindowOperator = (obj: RawObject, array: RawObject[], expr: {
    parentExpr: AnyVal;
    inputExpr: AnyVal;
    documentNumber: number;
    field: string;
}, options?: Options) => AnyVal;
declare type Operator = AccumulatorOperator | ExpressionOperator | PipelineOperator | ProjectionOperator | QueryOperator | WindowOperator;
/** Map of operator functions */
declare type OperatorMap = Record<string, Operator>;
/**
